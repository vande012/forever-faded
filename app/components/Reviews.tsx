...
const ReviewCard = ({ review }: { review: Review }) => (
  <div className="bg-white/10 p-6 rounded-lg shadow-lg">
    <div className="flex items-center mb-4">
      <div>
        <h3 className="font-urbanist font-semibold text-lg text-white">{review.name}</h3>
        <div className="flex">
          {[...Array(5)].map((_, i) => (
            <Star
              key={i}
  ...
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="font-urbanist text-6xl font-bold text-center mb-12 gold-gradient-text">What Our Clients Say</h2>
