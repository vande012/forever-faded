...
var dependencies = {
    ...
    "@strapi/provider-upload-local": "5.10.2",
    "@strapi/utils": "5.10.2",
    "byte-size": "8.1.1",
    cropperjs: "1.6.1",
    "date-fns": "2.30.0",
...
const admin = {
    register (app) {
        app.addMenuLink({
            ...
            Component: ()=>Promise.resolve().then(function () { return require('./App-Byq64LIq.js'); }).then((mod)=>({
                        default: mod.Upload
                    })),
            position: 4
        });
        app.addSettingsLink('global', {
            ...
            async Component () {
                const { ProtectedSettingsPage } = await Promise.resolve().then(function () { return require('./SettingsPage-BHZ5cn_M.js'); });
                return {
...
//# sourceMappingURL=index-CPGd7YRj.js.map
