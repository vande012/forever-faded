...
var EditPage = require('./EditPage-CycQlsFL.js');
require('react');
...
require('./selectors-Bf-6Fmez.js');
require('yup');
require('./index-HGaughzt.js');
...
const ProtectedCreatePage = ()=>{
    const permissions = Theme.useTypedSelector((state)=>state.admin_app.permissions.settings?.webhooks.create);
...
//# sourceMappingURL=CreatePage-DkzHz0zk.js.map
