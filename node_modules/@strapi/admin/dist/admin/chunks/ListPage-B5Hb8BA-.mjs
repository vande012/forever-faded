...
import { e as errorsTrads, q as useCreateUserMutation, F as Form, M as MemoizedInputRenderer, k as useAdminUsers, r as useDeleteManyUsersMutation, b as Layouts, S as SearchInput, s as Filters, T as Table, P as Pagination, C as ConfirmDialog } from './index-BM8-DG5K.mjs';
import { a as useNotification, e as useAPIErrorHandler, b as useTypedSelector, P as Page, k as useRBAC } from './Theme-C3oHrQcy.mjs';
...
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-DR4KBZkw.mjs';
...
import './useAdminRoles-C6Es4UUq.mjs';
...
const ModalForm = ({ onToggle })=>{
    ...
    const MagicLink = useEnterprise(MagicLinkCE, async ()=>(await import('./MagicLinkEE-EcyHC46Y.mjs')).MagicLinkEE);
...
const ListPage = ()=>{
    const UsersListPage = useEnterprise(ListPageCE, async ()=>// eslint-disable-next-line import/no-cycle
        (await import('./ListPage-PwzVjSsA.mjs')).UserListPageEE);
    // block rendering until the EE component is fully loaded
    if (!UsersListPage) {
        return null;
    }
...
//# sourceMappingURL=ListPage-B5Hb8BA-.mjs.map
