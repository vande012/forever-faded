...
import { z as createContext, S as StrapiAppProvider, A as AuthProvider, L as LanguageProvider, T as Theme, N as NotificationsProvider, B as TrackingProvider, G as GuidedTourProvider, D as ConfigurationProvider, E as LANGUAGE_LOCAL_STORAGE_KEY, P as Page, F as getIn, H as setIn, w as useConfiguration, b as useTypedSelector, d as useTypedDispatch, I as setLocale, u as useAuth, e as useAPIErrorHandler, J as useForgotPasswordMutation, a as useNotification, p as useAppInfo, K as getByteSize, c as useTracking, m as useGuidedTour, M as useGetRegistrationInfoQuery, O as useRegisterAdminMutation, Q as useRegisterUserMutation, o as login, U as useResetPasswordMutation, t as reducer$2, V as logout, W as THEME_LOCAL_STORAGE_KEY, r as getStoredToken, R as RBAC, n as useQueryParams, X as useTypedStore } from './Theme-C3oHrQcy.mjs';
 ...
 */ const getEERoutes$1 = ()=>window.strapi.isEE ? [
        {
            ...
            lazy: async ()=>{
                const { AuthResponse } = await import('./AuthResponse-Cu7HgPEK.mjs');
                return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
            {
                path: 'audit-logs',
                lazy: async ()=>{
                    const { ProtectedListPage } = await import('./ListPage-BVI0O8bq.mjs');
                    return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
            {
                path: 'single-sign-on',
                lazy: async ()=>{
                    const { ProtectedSSO } = await import('./SingleSignOnPage-CRzrEUGp.mjs');
                    return {
 ...
 * -----------------------------------------------------------------------------------------------*/ const AuthPage = ()=>{
    ...
    const { hasAdmin } = data ?? {};
    const Login$1 = useEnterprise(Login, async ()=>(await import('./Login-Dtkhd0GV.mjs')).LoginEE);
    const forms = useEnterprise(FORMS, async ()=>(await import('./constants-BddeukI7.mjs')).FORMS, {
...
const ROUTES_CE = [
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-srJutHdv.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-DQDa78K3.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-Bjr4f1Bs.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-B5Hb8BA-.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-MmQQ4hWc.mjs');
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-Cb-ETkOn.mjs');
            return {
                Component: ProtectedCreatePage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-C44OaxjN.mjs').then(function (n) { return n.b; });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-BhGt3EBQ.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView--KzJiQiO.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-DZaIevIB.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditViewPage-CwdhHAuX.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-CmubtWzn.mjs');
            return {
                Component: ProtectedCreateView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView-CoGoDDiF.mjs');
            return {
                Component: ProtectedListView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditView-CFIkvFrt.mjs');
            return {
                Component: ProtectedEditView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedInstalledPlugins } = await import('./InstalledPlugins-5j7xjDqh.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseAuditLogs } = await import('./PurchaseAuditLogs-BI41XTBD.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseSingleSignOn } = await import('./PurchaseSingleSignOn-G1TKPP15.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseContentHistory } = await import('./PurchaseContentHistory-BzC2C4Pv.mjs');
            return {
 ...
 */ const getImmutableRoutes = ()=>[
        {
            path: 'usecase',
            lazy: async ()=>{
                const { PrivateUseCasePage } = await import('./UseCasePage-Bro5fyP3.mjs');
                return {
...
const getInitialRoutes = ()=>[
        {
            index: true,
            lazy: async ()=>{
                const { HomePage } = await import('./HomePage-DGTeFboL.mjs');
                return {
                    Component: HomePage
                };
            }
        },
        {
            path: 'me',
            lazy: async ()=>{
                const { ProfilePage } = await import('./ProfilePage-CN8SAQ9w.mjs');
                return {
        ...
        },
        {
            path: 'marketplace',
            lazy: async ()=>{
                const { ProtectedMarketplacePage } = await import('./MarketplacePage-CcAYozK2.mjs');
                return {
        ...
        },
        {
            path: 'settings/*',
            lazy: async ()=>{
                const { Layout } = await import('./Layout-DYjtK6iP.mjs');
                return {
                    Component: Layout
                };
            },
            children: [
                {
                    ...
                    lazy: async ()=>{
                        const { ApplicationInfoPage } = await import('./ApplicationInfoPage-DiEcqVEU.mjs');
                        return {
        ...
        const routes = [
            {
                ...
                children: [
                    ...getImmutableRoutes(),
                    {
                        path: '/*',
                        lazy: async ()=>{
                            const { PrivateAdminLayout } = await import('./AuthenticatedLayout-C9eZ12Ue.mjs');
                            return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case './translations/en.json': return import('./en-n340Bke8.mjs');
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case './translations/en-GB.js': return import('./en-GB-3SrHvAFz.mjs');
    default: return new Promise(function(resolve, reject) {
      (typeof queueMicrotask === 'function' ? queueMicrotask : setTimeout)(
        reject.bind(null, new Error("Unknown variable dynamic import: " + path))
      );
...
//# sourceMappingURL=index-BM8-DG5K.mjs.map
