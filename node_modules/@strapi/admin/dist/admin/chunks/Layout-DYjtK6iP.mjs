...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index-BM8-DG5K.mjs';
import { u as useAuth, p as useAppInfo, q as useStrapiApp, c as useTracking, P as Page } from './Theme-C3oHrQcy.mjs';
...
const useSettingsMenu = ()=>{
   ...
   */ const ceLinks = React.useMemo(()=>SETTINGS_LINKS_CE(), []);
    const { admin: adminLinks, global: globalLinks } = useEnterprise(ceLinks, async ()=>(await import('./index-BM8-DG5K.mjs').then(function (n) { return n.O; })).SETTINGS_LINKS_EE(), {
...
export { Layout };
//# sourceMappingURL=Layout-DYjtK6iP.mjs.map
