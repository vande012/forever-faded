        ...
        ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
            {
                path: 'audit-logs',
                lazy: async ()=>{
                    const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-D21yUih2.js'); });
                    return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
            {
                path: 'single-sign-on',
                lazy: async ()=>{
                    const { ProtectedSSO } = await Promise.resolve().then(function () { return require('./SingleSignOnPage-DtRVlrGP.js'); });
                    return {
 ...
 * -----------------------------------------------------------------------------------------------*/ const AuthPage = ()=>{
    ...
    const { hasAdmin } = data ?? {};
    const Login$1 = useEnterprise.useEnterprise(Login, async ()=>(await Promise.resolve().then(function () { return require('./Login-Iw84AH9L.js'); })).LoginEE);
    const forms = useEnterprise.useEnterprise(FORMS, async ()=>(await Promise.resolve().then(function () { return require('./constants-CaerHoe3.js'); })).FORMS, {
...
const ROUTES_CE = [
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-CLXy5r60.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await Promise.resolve().then(function () { return require('./CreatePage-DbmpFjHt.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-CNaAuT5C.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-CWINpwfS.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-BrMhV8aB.js'); });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await Promise.resolve().then(function () { return require('./CreatePage-DkzHz0zk.js'); });
            return {
                Component: ProtectedCreatePage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-CycQlsFL.js'); }).then(function (n) { return n.EditPage$1; });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-DbfL2rpi.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await Promise.resolve().then(function () { return require('./ListView-DzwvQ8nW.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await Promise.resolve().then(function () { return require('./CreateView-yjsS9KUJ.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await Promise.resolve().then(function () { return require('./EditViewPage-DBga-70A.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await Promise.resolve().then(function () { return require('./CreateView-CE4-drK6.js'); });
            return {
                Component: ProtectedCreateView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await Promise.resolve().then(function () { return require('./ListView-DGfxO89i.js'); });
            return {
                Component: ProtectedListView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await Promise.resolve().then(function () { return require('./EditView-C9cKaoY1.js'); });
            return {
                Component: ProtectedEditView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedInstalledPlugins } = await Promise.resolve().then(function () { return require('./InstalledPlugins-BXM3i3xr.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseAuditLogs } = await Promise.resolve().then(function () { return require('./PurchaseAuditLogs-DnWVbru3.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseSingleSignOn } = await Promise.resolve().then(function () { return require('./PurchaseSingleSignOn-Bq0YHAHt.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseContentHistory } = await Promise.resolve().then(function () { return require('./PurchaseContentHistory-DUk7otrp.js'); });
            return {
 ...
 */ const getImmutableRoutes = ()=>[
        {
            path: 'usecase',
            lazy: async ()=>{
                const { PrivateUseCasePage } = await Promise.resolve().then(function () { return require('./UseCasePage-CipG2GC4.js'); });
                return {
...
const getInitialRoutes = ()=>[
        {
            index: true,
            lazy: async ()=>{
                const { HomePage } = await Promise.resolve().then(function () { return require('./HomePage-CVc0RfvD.js'); });
                return {
                    Component: HomePage
                };
            }
        },
        {
            path: 'me',
            lazy: async ()=>{
                const { ProfilePage } = await Promise.resolve().then(function () { return require('./ProfilePage-DiGV7o6c.js'); });
                return {
        ...
        },
        {
            path: 'marketplace',
            lazy: async ()=>{
                const { ProtectedMarketplacePage } = await Promise.resolve().then(function () { return require('./MarketplacePage-BmqfuAvB.js'); });
                return {
        ...
        },
        {
            path: 'settings/*',
            lazy: async ()=>{
                const { Layout } = await Promise.resolve().then(function () { return require('./Layout-DST1PxaO.js'); });
                return {
                    Component: Layout
                };
            },
            children: [
                {
                    ...
                    lazy: async ()=>{
                        const { ApplicationInfoPage } = await Promise.resolve().then(function () { return require('./ApplicationInfoPage-CsBvES_c.js'); });
                        return {
        ...
        const routes = [
            {
                ...
                children: [
                    ...getImmutableRoutes(),
                    {
                        path: '/*',
                        lazy: async ()=>{
                            const { PrivateAdminLayout } = await Promise.resolve().then(function () { return require('./AuthenticatedLayout-D_VSoB1l.js'); });
                            return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case './translations/en.json': return Promise.resolve().then(function () { return require('./en-rWmm12oE.js'); });
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case './translations/en-GB.js': return Promise.resolve().then(function () { return require('./en-GB-Cc-PTeUP.js'); });
    default: return new Promise(function(resolve, reject) {
      (typeof queueMicrotask === 'function' ? queueMicrotask : setTimeout)(
        reject.bind(null, new Error("Unknown variable dynamic import: " + path))
      );
...
//# sourceMappingURL=index-HGaughzt.js.map
